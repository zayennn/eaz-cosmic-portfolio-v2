<nav class="navbar" id="navbar">
    <div class="nav-container">
        ...
        <a href="https://drive.google.com/uc?export=download&id=1fETTGmYvCBiWBjH9rs_JzluoamUCg4Ur" class="nav-cv-btn">Download CV</a>
        ...
        <div class="mobile-menu-overlay" id="mobileMenuOverlay">
            ...
            <div class="mobile-menu-content">
                ...
                <a href="https://drive.google.com/uc?export=download&id=1fETTGmYvCBiWBjH9rs_JzluoamUCg4Ur" class="mobile-cv-btn">
                    Download CV 
